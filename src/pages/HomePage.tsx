...
const anhCLB = require("../assets/img/clb.jpg");
const review = require("../assets/img/review.png");
const document = require("../assets/img/book.png");
const banner = require("../assets/img/banner.jpg");
const qa = require("../assets/img/qa.png");
