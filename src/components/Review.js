    ...
    <div className='w-full my-6 mx-4 mt-0 pb-3 p-2 rounded-lg border border-gray-300 flex flex-col'>
          ...
          <Avatar sx={{ width: 32, height: 32 }} src={avatar}></Avatar>
            <div className='text-sm flex flex-col px-3 w-full'>
              ...
              <span className='font-normal opacity-60'>{review.author_schoolyear}</span>
            </div>
        ...
        <span className="mx-2 px-1 py-1 rounded-md text-xs bg-gray-400 text-white w-fit flex items-center"><SchoolOutlinedIcon/> <span className='px-2'>Kì {review.time}</span></span>
        </div>
        
        <div className=' px-3'>
        <div className='p-3'>
          <p className=' text-sm box-border overflow-hidden flex items-center'>
            <SchoolOutlinedIcon/> <span className='px-2'>{review.description}</span>
          </p>
        </div>
        ...
        <div className='text-right'><button className='text-sm opacity-80'>Xem thêm...</button></div>
        </div>
    </div>
