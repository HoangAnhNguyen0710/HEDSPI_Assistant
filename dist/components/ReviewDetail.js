...
var ReviewDetail = function (props) {
    ...
    (0, react_1.useEffect)(function () {
        (0, api_1.getReviewCmt)(review.id).then(function (res) {
    ...
    (0, react_1.useEffect)(function () {
        setTimeout(function () {
            if (user !== null) {
                (0, api_1.checkHasLike)(user.id, review.id, "review")
                    .then(function (res) {
                    setIsLiked(true);
                    console.log(res);
    ...
    var LikeOrDislike = function () {
        if (user !== null) {
            if (isLiked === false) {
                (0, api_1.postLike)(user, review, "review")
                    .then(function (res) {
                    setLikeId(res.data.id);
                    setIsLiked(true);
    ...
    return (react_1.default.createElement("div", { className: "w-full p-2 flex flex-col max-w-xl" },
        react_1.default.createElement("div", { className: "font-semibold py-1 text-lg uppercase" }, review.title),
        react_1.default.createElement("div", { className: "py-1 text-sm flex items-center flex-wrap" },
            ...
            react_1.default.createElement("span", { className: "pr-2" }, "Hoang Anh Nguyen"),
            react_1.default.createElement("span", null,
                "---",
                (0, moment_1.default)(review.createdAt).format("MMMM Do YYYY, h:mm:ss a"),
                "---")),
        react_1.default.createElement("div", { className: "py-3" }, review.topic.map(function (topic) { return (react_1.default.createElement("span", { className: "mr-2", key: topic.toString() },
            react_1.default.createElement(material_1.Chip, { icon: react_1.default.createElement(SellOutlined_1.default, null), label: topic }))); })),
        react_1.default.createElement("div", { className: "my-4 p-4 rounded-md border-2 overflow-y-auto", dangerouslySetInnerHTML: { __html: review.description } }),
        ...
        react_1.default.createElement("div", { className: "w-4/5 py-4 rounded-md" },
            react_1.default.createElement(CreateCommentForm_1.default, { infor: review, type: "review", updateData: updateData, setUpdateData: setUpdateData }))));
};
exports.default = ReviewDetail;
