...
var CreateQuestionForm = function () {
    //user hiện tại
    ...
    var _a = (0, react_2.useState)(defaultQ), question = _a[0], setQuestion = _a[1];
    //quản lý list topic
    ...
    var handleChange = function (e) {
        var _a;
        setQuestion(__assign(__assign({}, question), (_a = {}, _a[e.target.name] = e.target.value, _a)));
    };
    var handleSubmit = function (e) {
        e.preventDefault();
        if (confirm === true) {
            var uploadQ = question;
            uploadQ.topic = topicList;
            // setQuestion(uploadQ);
            (0, api_1.postQuestion)(uploadQ)
                .then(function (res) {
                console.log(res);
                setMSGType("success");
    ...
    return (react_1.default.createElement("div", { className: "w-full m-2 p-2" },
        react_1.default.createElement("span", { className: "py-3 text-2xl font-semibold" }, "T\u1EA1o c\u00E2u h\u1ECFi"),
        react_1.default.createElement("form", { className: "py-6", onSubmit: handleSubmit },
            react_1.default.createElement("div", { className: "flex flex-wrap" },
                react_1.default.createElement(material_1.TextField, { name: "title", value: question.title, fullWidth: true, label: "Ti\u00EAu \u0111\u1EC1", id: "fullWidth", 
                ...
                react_1.default.createElement("div", { className: "w-4/5 mb-4 pt-1 pr-3" },
                    react_1.default.createElement(material_1.FormControl, { size: "small", fullWidth: true },
                        ...
                        react_1.default.createElement(material_1.Select, { labelId: "demo-select-small", id: "demo-select-small", fullWidth: true, label: "Th\u1EC3 lo\u1EA1i", name: "type", value: question.type, onChange: handleChange },
                            react_1.default.createElement(material_1.MenuItem, { value: "H\u1ECDc t\u1EADp" }, "H\u1ECDc t\u1EADp"),
                            react_1.default.createElement(material_1.MenuItem, { value: "Jobfair - Naitei" }, "Jobfair - Naitei"),
                            react_1.default.createElement(material_1.MenuItem, { value: "\u0110\u1EDDi s\u1ED1ng" }, "\u0110\u1EDDi s\u1ED1ng"),
                            react_1.default.createElement(material_1.MenuItem, { value: "Kh\u00E1c" }, "Kh\u00E1c"))))),
            react_1.default.createElement("div", { className: "my-4 w-full", ref: editor },
                react_1.default.createElement(jodit_react_ts_1.default, { defaultValue: question.description, 
                    // tabIndex={1} // tabIndex of textarea
                    onChange: function (newContent) { return setQuestion(__assign(__assign({}, question), { description: newContent })); }, config: config })),
            react_1.default.createElement("div", { className: "" },
                react_1.default.createElement(material_1.Button, { variant: "contained", type: "submit", onClick: function () { return setConfirm(true); } }, "T\u1EA1o c\u00E2u h\u1ECFi"))),
...
exports.default = CreateQuestionForm;
